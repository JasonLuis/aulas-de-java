...
public class CategoriaController {
	...
	@GetMapping("/{id}")
	@ApiOperation(value = "Retorna uma categoria a partir do identificador")
	...
	@PutMapping("/{id}")
	@ApiOperation(value = "Atualiza uma categoria a partir do identificador")
	...
	@DeleteMapping("/{id}")
	@ApiOperation(value = "Exclui uma categoria a partir do identificador")
