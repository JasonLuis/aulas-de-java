...
public class CategoriaControllerIntegrationTest {
	...
	@Test
	@DisplayName("Deve salvar uma categoria, retornar status 201 e Location no Header")
	...
	@Test
	@DisplayName("Deve atualizar uma categoria pelo id e retornar status 200")
	...
	@Test
	@DisplayName("Deve deletar uma categoria pelo id e retornar status 204")
	...
	@Test
	@DisplayName("Não deve deletar uma categoria associada a produto e retornar status 500")
