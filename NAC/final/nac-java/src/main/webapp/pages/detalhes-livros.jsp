...
<body style="background: #E5E7E9">
	...
	<div class="container border border-dark" style="margin-bottom:30px">
		...
		<h1 style="text-align: center;margin-bottom:50px;"  >${livro.titulo}</h1>
			...
			<p style="margin:30px 20px;padding:10px;background: #fff;border-radius:10px"><span class="font-weight-bold">Preço </span> : R$ ${livro.preco}</p>
		
		
			<p style="margin:30px 20px;padding:10px;background: #fff;border-radius:10px"><span class="font-weight-bold">Gênero </span> : ${livro.genero}</p>
